...
\clearpage
%%
\section{Minor Oral Surgery by Category} % 4
...
%    \centering
    \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (2,0) {\includegraphics[width=4.0cm]{350D3956-2AD4-4C18-B38F-5DEC07BC59F8.jpeg}};
...
\clearpage
%%
\subsection{Procedures Involved in Soft-tissue Oral Surgery (minor)}
...
\clearpage
%%
\includegraphics[width=12cm]{IMG_5180_photo_preOP_face.jpeg}
\includegraphics[width=12cm]{IMG_5286_localAnesthesia_I&D.jpeg}
\includegraphics[width=12cm]{IMG_5296_CT_temporalAbscess.jpeg}
