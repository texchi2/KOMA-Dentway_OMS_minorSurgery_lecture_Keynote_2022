...
\newcommand*{\mytitle}{\capitalisewords{Brief Introduction of Minor Oral Surgery}}
...
%\vspace{35mm}
\hspace{12cm}  \textcolor{white}{\today}. %{\mydate} %\par % Date
...
\clearpage
%%
\section{Vocabulary by Category} % 4

%\\
\begin{center} %[H]
    \centering
    \captionsetup{labelformat=empty}
    \captionof{table}{Let's go over some words again:}
    % \captionabove{}
